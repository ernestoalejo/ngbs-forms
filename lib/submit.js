...
Submit.prototype.build = function(output) {
  output.template('submit', {
    ...
    trySubmitFunc:  this.form.trySubmitFunc_ && this.form.trySubmitFunc_ + '();',
    submitFunc: this.form.name_ + '.$valid && ' + this.form.submitFunc_ + '()',
    submitOnForm: this.form.submitOnForm_,
  });
};
